...
<body>
    ...
    $query = "SELECT area.plantlocationID,plantdetail.PlantName FROM area RIGHT JOIN plantdetail ON area.PlandetailtID = plantdetail.PlandetailtID WHERE area.PlandetailtID = '" . $ID . "'" or die("Error:" . mysqli_error());
    ...
    while ($row = mysqli_fetch_array($result)) {
        echo "<tr>";
        echo "<th><a href='PlantdetailForm.php?ID=$row[0]'>" . $row["plantlocationID"] .  "</th> ";
